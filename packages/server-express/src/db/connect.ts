...
if (!uri) throw new Error('No URI, not URL to connect to mongoDB')

export const client = new MongoClient(uri)
export const projectName = 'LanguageDetection'
export const dbDetectionServices = 'detection_services'
...
export const connectDb = async () => {
  ...
  console.info(`Connected to db 🚀: '${dbDetectionServices}'`)
}